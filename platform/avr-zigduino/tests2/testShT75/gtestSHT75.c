...
/*---------------------------------------------------------------------------*/
PROCESS(gtestSHT75_process, "gtest SHT75");
AUTOSTART_PROCESSES(&gtestSHT75_process);
/*---------------------------------------------------------------------------*/
PROCESS_THREAD(gtestSHT75_process, ev, data)
{
    PROCESS_BEGIN();
